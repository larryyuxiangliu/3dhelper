...
for PP = PPs
    for N0 = N0s
        ...
        q = 500;
        M2 = 21;    % the points on the box, how many points along 1 direction on each surface; so totally 6*M2^2 points on the box;
        ...
        src3D = srcBdy3D(aa, bb, N1, h, q, Rt);
        ...
        if 1,
            ...
            error = getBdyError(M_test, P_test, aa, bb, Rt, xs,ys,zs, 0, 0, 0, k,0, kx, ky, kz, PP,eta, xi, nei ,alpha, beta, ex, ey, type);
