function Q = QuasiPerQ3D(t, bo, l, r, f, ba,  M,  P, N0, NN, k,kx, ky, ex,ey, alpha, beta)
%
...
Q(6*m+1:7*m, 1:N) = Abo;
Q(7*m+1:8*m, 1:N) = Anbo;
W = RBW3D(t, bo, M, N0, NN, k, kx, ky, ex, ey);
Q(4*m+1:8*m, N+1 :N + 2 * NN) = -W;
