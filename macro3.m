...
for PP = PPs
    for N0 = N0s
N1 = 250;    % the number of boundary pts on the object in the r-z plane;
...
src3D_p = source3DQuad(f, f_t, N1, q, Rt, hp);      % curve MFS points, propotional to local speed;
src3D_m = source3DQuad(f, f_t, N1, q, Rt, hm);
...
if 1,
    ...
    error = getBdyError(M_test, P_test, f, f_t, Rt, xsp,ysp,zsp, xsm, ysm, zsm, kp,km, kx, ky, kz, PP,eta, xi, nei ,alpha, beta, ex, ey, type);
