...
clear all;
tic;
filename = 'neumann_nonper_results.txt';
...
fprintf(fid, 'Parameters: M = %d, N = %d, P = %d, Q = %d, h = %2.2f, k = %d \n', M, N, P, Q, h, k); 
...
toc;    
     fprintf(fid, 'the boundary condition matching error is %e, time for the code is %4.2f seconds \n ',...
                err, toc);   
