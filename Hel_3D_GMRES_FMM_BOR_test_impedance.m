...
tic;
filename = 'dirichilet_impedance.txt';
...
BO.z = BO.z ; 
fprintf(fid, '---------------- Now maxlevel = 3 & impedance condition on the bottom at z = -1 ----------------------------------- \n');
...
B = QuasiPerB3D_impedance(target, PP,NN, k);
C = QuasiPerC3D_impedance(TT,BO,LL,RR,FF,BA, xs,ys,zs, k, ex, ey, nei, alpha, beta);
Q = QuasiPerQ3D_impedance(TT,BO,LL,RR,FF,BA, M2, PP, N0,NN, k, kx, ky, ex,ey, alpha, beta);
